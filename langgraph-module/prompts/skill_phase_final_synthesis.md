...
8. When the data for a component is missing, replace the whole thing with a "לא נמצא מידע רלוונטי לנושא {}", make sure to not leave it in a mermaid format, making it break.
